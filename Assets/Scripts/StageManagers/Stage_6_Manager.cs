...
public class Stage_6_Manager : StageManager
{
    ...
    public override void SetupEvents()
    {
        ...
        AddEvent(1, ShowPlayerUIMessage); //click-> 朋友們：今天是你的生日啊，生日快樂！
        AddEvent(2, PlayBirthdaySong); //click->Play Birthday song
        AddEvent(3, ShowPlayerUIMessage); //Delay->主角：謝謝你們...有你們真好！
        ...
        AddEvent(8, Seperate); //走到朋友A面前，做出擁抱姿勢後click->Seperate
        AddEvent(9, LonelyVoice); //delay->showMessage
        AddEvent(10, AllSeperate); //delay->allSeperate+PlaySFX
    ...
    {
        PlaySFX();
        Delay(8f, ShowPlayerUIMessage); //主角：謝謝你們...有你們真好！
    }
