...
public class Stage_2_Manager : StageManager
{
    ...
    public override void SetupEvents()
    {
        ...
        // total event: 18
        // touch event(14): 1 3 4 5 7 8 9 10 11 13 14 15 16 17
        // text event(11)
        // show image(3): 2 6 12
        ...
        // 14: button down -> show message: 室友：但他最近壓力很大，常常一喝就是好幾瓶，還會發酒瘋。
        
        AddEvent(15, ShowPlayerUIMessage);   
        // 15: button down -> show message: 嗯...。看來矛求學長是因為課業不順才跳樓的... 
        
        AddEvent(16, ShowPlayerUIMessage);   
        // 16: button down -> show message: 我還是回去念書，免得跟他一樣 
        ...
        //StartCoroutine(RunEntireFlow(18));
    }
